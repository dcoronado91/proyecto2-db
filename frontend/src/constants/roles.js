// Todos los roles de staff (no cliente) — usado para distinguir staff vs cliente
...
export const ROLES_INVENTARIO = ['admin', 'bodeguero']
export const ROLES_CLIENTES   = ['admin', 'gerente']
